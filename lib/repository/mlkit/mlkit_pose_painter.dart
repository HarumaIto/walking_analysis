...
import 'mlkit_coordinates_translator.dart';

class MlKitPosePainter extends CustomPainter {
  MlKitPosePainter(this.pose, this.absoluteImageSize, this.rotation);
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paintLine(PoseLandmarkType.rightHip, PoseLandmarkType.rightAnkle, rightPaint);
  }

  @override
  bool shouldRepaint(covariant MlKitPosePainter oldDelegate) {
